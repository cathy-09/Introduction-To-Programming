...
`Задача 7: Напишете функция, която приема две числа. Функцията да проверява дали първото число се дели на второто без остатък, без да използвате оператора за делене по модул %.`
