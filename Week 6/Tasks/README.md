...
> АЛГОРИТЪМ:
> 
> Обхожда редовете i от 0 до n-1.
>
> За всеки ред i обхожда само колоните над диагонала (j = i + 1 до n-1):
>
> Проверява дали matrix[i][j] != matrix[j][i].
>
> Ако е различно → матрицата не е симетрична, връща false.
>
> Ако всички съответстващи елементи са равни, връща true.
